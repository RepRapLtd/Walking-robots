...
part = 1; // [0:Both Gears, 1:1st Gear Only, 2:2nd Gear Only]

// The number of teeth in the 1st gear
gear1_teeth = 10;

// The number of teeth in the 2nd gear (should be odd when generating both at once)
gear2_teeth = 9;

// The desired angle between the input and output shafts 
axis_angle = 90;  
